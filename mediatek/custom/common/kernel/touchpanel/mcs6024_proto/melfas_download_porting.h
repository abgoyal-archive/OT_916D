...
1. melfas_download_porting.h
   ...
   4. Delay function pharameter constants ( with udelay() )
...
// VDD
//----------------
#if MCSDL_USE_VDD_CONTROL//sunshine need to define
#define TKEY_VDD_SET_HIGH()
#define TKEY_VDD_SET_LOW()
#else
#define TKEY_VDD_SET_HIGH()             											// Nothing
#define TKEY_VDD_SET_LOW()              											// Nothing
#endif

//sunshine VDD µø¿œ. N/A
//----------------
// CE
//----------------
#if MCSDL_USE_CE_CONTROL
#define TKEY_CE_SET_HIGH()   	          		mt_set_gpio_out(GPIO21, GPIO_OUT_ONE)
#define TKEY_CE_SET_LOW()      	        		mt_set_gpio_out(GPIO21, GPIO_OUT_ZERO)
#define TKEY_CE_SET_OUTPUT()   	        		mt_set_gpio_dir(GPIO21, GPIO_DIR_OUT)
#else
...
// INTR
//----------------
#if MCSDL_USE_INTR_CONTROL//sunshine need to define
#define TKEY_INTR_SET_HIGH()             			mt_set_gpio_out(GPIO187, GPIO_OUT_ONE)
#define TKEY_INTR_SET_LOW()              			mt_set_gpio_out(GPIO187, GPIO_OUT_ZERO)
#define TKEY_INTR_SET_OUTPUT()             			mt_set_gpio_dir(GPIO187, GPIO_DIR_OUT)
#define TKEY_INTR_SET_INPUT()             			mt_set_gpio_dir(GPIO187, GPIO_DIR_IN)
#else
...
#define TKEY_RESETB_SET_HIGH()
#define TKEY_RESETB_SET_LOW()
...
//sunshine need to define
//------------------
// I2C SCL & SDA
//------------------
// 181 for scl,	182 for sda
#define TKEY_I2C_SCL_SET_HIGH()					mt_set_gpio_out(GPIO181, GPIO_OUT_ONE)
#define TKEY_I2C_SCL_SET_LOW()						mt_set_gpio_out(GPIO181, GPIO_OUT_ZERO)

#define TKEY_I2C_SDA_SET_HIGH()					mt_set_gpio_out(GPIO182, GPIO_OUT_ONE)
#define TKEY_I2C_SDA_SET_LOW()						mt_set_gpio_out(GPIO182, GPIO_OUT_ZERO)

#define TKEY_I2C_SCL_SET_OUTPUT()					mt_set_gpio_dir(GPIO181, GPIO_DIR_OUT)
#define TKEY_I2C_SDA_SET_OUTPUT()					mt_set_gpio_dir(GPIO182, GPIO_DIR_OUT)
